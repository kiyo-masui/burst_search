...
static char __pyx_k_home_aroman_burst_search_burst[] = "/home/aroman/burst_search/burst_search/_preprocess.pyx";
...
static PyMethodDef __pyx_mdef_12burst_search_11_preprocess_1remove_continuum_v2 = {"remove_continuum_v2", (PyCFunction)__pyx_pw_12burst_search_11_preprocess_1remove_continuum_v2, METH_O, 0};
 ...
 */
  ...
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(1, 0, 3, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_aroman_burst_search_burst, __pyx_n_s_remove_continuum_v2, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_preprocess", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
