...
size_t burst_dm_transform(DTYPE *indata1, DTYPE *indata2, CM_DTYPE *chan_map, DTYPE *outdata, size_t nfreq, float freq0, float delta_f,size_t ntime1, size_t ntime2, float delta_t, int depth);
